const LOCAL_API = location.hostname === "localhost" || location.hostname === "127.0.0.1" ? "http://127.0.0.1:8620" : "";
const API_BASE = window.API_BASE_URL || (location.port === "8621" ? "" : LOCAL_API);
